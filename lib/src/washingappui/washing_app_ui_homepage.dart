...
class WashingAppHomePage extends StatefulWidget {
  @override
  _WashingAppHomePageState createState() => _WashingAppHomePageState();
}

class _WashingAppHomePageState extends State<WashingAppHomePage> {
  @override
