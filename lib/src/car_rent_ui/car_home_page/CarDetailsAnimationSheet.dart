import 'package:ecommerce/src/car_rent_ui/car_home_page/carDetails.dart';
import 'package:flutter/material.dart';
import 'bloc_car/state_bloc.dart';
import 'bloc_car/state_provider.dart';

StateBloc stagebloc = StateBloc();
...
reverse(){
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<Object>(
      ...
      stream: stagebloc.animationStatus,
